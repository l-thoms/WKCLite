...
> [!WARNING]
> 通信协议已升级至 v0.2.0.0, 与旧版手机客户端不再兼容。请及时更新手机客户端 [WKCCommunicator](https://github.com/l-thoms/WKCCommunicator) 至最新版本。
...
## 使用提醒
* 摄像头建议使用 PAL 制式，清晰度更高；头显建议选择反交错及梳状滤波功能好一点的。
